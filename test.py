...
class DataStructureTest(unittest.TestCase):
  ...
  def test_manipulate_dictionary(self):
    ...
    self.assertEqual(result, ["grapes", "mangoes", "apples", "oranges"], msg = "Dictionary not manipulated" )

if __name__ == "main":
  dataStructuret = DataStructureTest()
  print dataStructuret.test_manipulate_list()